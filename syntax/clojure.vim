...
let s:clojure_syntax_keywords = {
    ...
    \ , 'clojureConstant': ["nil"]
    \ , 'clojureDefine': ["clojure.core/definline","clojure.core/fn","fn","clojure.core/definterface","clojure.core/defmacro","clojure.core/defmethod","clojure.core/defmulti","clojure.core/defn","clojure.core/defn-","clojure.core/defonce","clojure.core/defprotocol","clojure.core/defrecord","clojure.core/defstruct","clojure.core/deftype","definline","definterface","defmacro","defmethod","defmulti","defn","def","defn-","defonce","defprotocol","defrecord","defstruct","deftype"]
    ...
    \ , 'clojureSpecial': [".","clojure.core/let","clojure.core/loop","do","if","let","loop","monitor-enter","monitor-exit","new","quote","recur","set!","var"]
...
highlight default link clojureSpecial                   Conditional
